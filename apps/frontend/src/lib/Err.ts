// src/lib/Err.ts
export type Result<T, E> = { success: true; data: T; error: undefined } | { success: false; data: undefined; error: E };

export const catchErrTyped = async <T, E extends new (message?: string) => Error>(
  promise: Promise<T>,
  errorsToCatch?: E[]

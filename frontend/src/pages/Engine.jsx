...
//           <div className="w-full sm:w-[12rem] md:w-[15rem] lg:w-[16rem] h-[15rem] 2xl:w-[26.5rem] 2xl:h-[23rem] font-semibold bg-base-200 text-black flex flex-col items-center pt-4 px-4 rounded-lg shadow-md">
//             <p className="text-center font-semibold text-md">CHARGE ALT VOLTAGE</p>
//             <div
//               className="text-6xl sm:text-7xl md:text-8xl lg:text-8xl 2xl:text-9xl my-5"
//               style={{ color: "rgba(177, 213, 189, 1)" }}>
//               <FaBolt />
...
//         <h2 className="text-center text-sm lg:text-md 2xl:text-lg mb-4 whitespace-nowrap">FUEL LEVEL</h2>
...
const Engine = () => {
  ...
  const [fuelHeight, setfuelHeight]= useState();
    ...
    const getData = async () => {
      try {
        ...
        if (response.ok && data) {
          ...
          console.log("result for genset id 4", result4);
          const fuelLevel= result4[0].propertyValue;
          console.log("genset id is 4 value",fuelLevel);
          // eslint-disable-next-line no-unused-vars
          let fuelPercentage1=(fuelLevel/ 50)*100;
          ...
          if (id !== null) {
            ...
            setbatteryVoltValue(batteryVolt);
            setfuelLevelValue(fuelLevel);
            setfuelPercentage(fuelPercentage1);
            setfuelHeight(fuelLevel);

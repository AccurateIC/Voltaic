...
import AnamoliesWeek from "../components/Anamolies/AnamoliesWeek";
import AnamoliesLineChart from "../components/Anamolies/AnamoliesLineChart";
      ...
      <div className="bg-gray-900 text-white min-h-screen p-6">
        ...
        <div className="mt-6 bg-gray-800 p-4 rounded-lg shadow-lg overflow-x-auto">
          <button
            ...
            style={{
              boxShadow:
                "inset 2px 2px 5px rgba(0, 0, 0, 0.1), 0px 4px 4px 0px #0000007A, inset 1px 4px 4px 0px #FFFFFFBF",
            }}

...
import {
  convertPaletteToComplementDarkTheme,
  generateBaseColor,
    ...
    <dialog className="modal" open={isOpen}>
      <div className="modal-box">
        ...
        <div className="py-4 flex flex-row h-64 gap-2">
          <div>Palette</div>
          <div
            style={{ backgroundColor: baseRgb1 }}
            className={`flex-1 rounded`}
          ></div>
          <div
            style={{ backgroundColor: lightRgb1 }}
            className={`flex-1 rounded`}
          ></div>
          <div
            style={{ backgroundColor: darkRgb1 }}
            className={`flex-1 rounded`}
          ></div>
          <div
            style={{ backgroundColor: complementRgb1 }}
            className={`flex-1 rounded`}
          ></div>
          <div
            style={{ backgroundColor: accentRgb1 }}
            className={`flex-1 rounded`}
          ></div>
        </div>
        <button className="btn" onClick={regenerateCallback}>
          Regenerate
        </button>
...
const TestChart = () => {
  ...
  const [cursorBgColor, setCursorBgColor] = useState({
    h: 200,
    s: 0.1,
    l: 0.82,
    a: 0.25,
  ...
  useMessageBus("theme-switch", (msg) => {
    ...
    if (currentTheme === "business") {
      ...
      setCursorBgColor({ h: 200, s: 0.1, l: 0.82, a: 0.25 });
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="m-4">
        ...
        <button className="btn" onClick={regeneratePalette}>
          Regenerate
        </button>
        <ColorPaletteModal
          isOpen={isModalOpen}

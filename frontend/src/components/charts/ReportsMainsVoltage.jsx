...
// // const ReportsMainsVoltage = ({ timeFilter }) => {
...
// //       <span className="text-white text-sm font-semibold mb-2">MAINS VOLTAGE ({timeFilter})</span>
// //       <div className="aspect-video bg-[#303030] rounded-xl p-2">
// //         <Line data={voltage} options={chartOptions} />
// //       </div>
// //       <p className="text-sm text-gray-300 mt-2 hidden pdf-only">Mains voltage trends across L1, L2, and L3 phases.</p>
// //     </div>
// //   );
// // };
...
// export const ReportsMainsVoltage = ({ mainVoltageData }) => {
//   const options = {
//     responsive: true,
//     maintainAspectRatio: false,
//     plugins: {
...
//   const l1Data = mainVoltageData.map((item) => ({ x: item.timestamp, y: item.L1 }));
//   const l2Data = mainVoltageData.map((item) => ({ x: item.timestamp, y: item.L2 }));
//   const l3Data = mainVoltageData.map((item) => ({ x: item.timestamp, y: item.L3 }));
...
const ReportsMainsVoltage = ({ mainVoltageData = [] }) => {
  // Ensure chronological order
  const sortedData = [...mainVoltageData].sort(
